...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute w-fit top-16 right-16 mt-2 rounded-2xl bg-black/20 backdrop-blur-2xl border border-white/10 overflow-hidden transition-all duration-300 ${
          isMenuOpen
